...
class GnssComponent(context: Context) : Component {
    class Factory : Component.Factory {
        override fun create(context: Context) = GnssComponent(context)
    }

    private val locationManager = context.getSystemService(LocationManager::class.java)

    override val name = "gnss"

    override val title = LocalizedString(R.string.section_gnss_name)

    override val description = LocalizedString(R.string.section_gnss_description)

    override val drawableResId = R.drawable.ic_satellite_alt

    override val permissions = setOf(Permission.LOCATION)
            ...
            val screen = Screen.CardListScreen(
                ...
                elements = listOfNotNull(
                    Element.Card(
                        ...
                        title = LocalizedString(R.string.gnss_general),
                        elements = listOfNotNull(
                            *if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                                listOfNotNull(
                                    Element.Item(
                                        identifier = identifier / "general" / "location_enabled",
                                    ...
                                    locationManager.gnssHardwareModelName?.let {
                                        Element.Item(
                                            identifier = identifier / "general" / "hardware_model_name",
                                            title = LocalizedString(R.string.gnss_hardware_model_name),
                                            value = Value(it),
                                        )
                                    },
                                    Element.Item(
                                        identifier = identifier / "general" / "year_of_hardware",
                            ...
                            Element.Item(
                                identifier = identifier / "general" / "providers",
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        ...
                        Element.Card(
                            ...
                            elements = listOf(
                                ...
                                Element.Item(
                                    identifier = identifier / "capabilities" / "supports_antenna_info",
                                ...
                                *if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
                                    arrayOf(
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_satellite_pvt",
                                            title = LocalizedString(R.string.gnss_capabilities_has_satellite_pvt),
                                            value = Value(gnssCapabilities.hasSatellitePvt()),
                                        ),
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_measurement_corrections",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_measurement_correlation_vectors",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_measurement_corrections_for_driving",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_accumulated_delta_range",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_measurement_corrections_los_sats",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_measurement_corrections_excess_path_length",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_measurement_corrections_reflecting_plane",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_power_total",
                                            title = LocalizedString(R.string.gnss_capabilities_has_power_total),
                                            value = Value(gnssCapabilities.hasPowerTotal()),
                                        ),
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_power_singleband_tracking",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_power_multiband_tracking",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_power_singleband_acquisition",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_power_multiband_acquisition",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "capabilities" / "has_power_other_modes",
                    ...
                    *if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
                        locationManager.gnssCapabilities.gnssSignalTypes.withIndex().map { (i, gnssSignalType) ->
                            Element.Card(
                                identifier = identifier / "signal_type_${i}",
                                ...
                                elements = listOf(
                                    Element.Item(
                                        identifier = identifier / "signal_type_${i}" / "constellation_type",
                    ...
                    *if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        locationManager.gnssAntennaInfos?.withIndex()?.map { (i, antennaInfo) ->
                            ...
                            Element.Card(
                                identifier = identifier / "antenna_$i",
                                title = LocalizedString(R.string.gnss_antenna_title, i),
                                elements = listOf(
                                    Element.Item(
                                        identifier = identifier / "antenna_$i" / "carrier_frequency",
                                    ...
                                    Element.Item(
                                        identifier = identifier / "antenna_$i" / "phase_center_offset",
                                    ...
                                    Element.Item(
                                        identifier = identifier / "antenna_$i" / "phase_center_variation_corrections",
                                    ...
                                    Element.Item(
                                        identifier = identifier / "antenna_$i" / "signal_gain_corrections",
