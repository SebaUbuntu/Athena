...
class BuildComponent(context: Context) : Component {
    class Factory : Component.Factory {
        override fun create(context: Context) = BuildComponent(context)
    }
    ...
    override val title = LocalizedString(R.string.section_build_name)
