...
class DrmComponent : Component {
    class Factory : Component.Factory {
        override fun create(context: Context) = DrmComponent()
    }

    override val name = "drm"

    override val title = LocalizedString(R.string.section_drm_name)

    override val description = LocalizedString(R.string.section_drm_description)

    override val drawableResId = R.drawable.ic_live_tv
            ...
            val screen = Screen.ItemListScreen(
                ...
                elements = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                    ...
                    val item = mediaDrm?.let { mediaDrm ->
                        Element.Item(
                            identifier = identifier / uuid.toString(),
                            title = LocalizedString(name),
                            isNavigable = true,
                            drawableResId = R.drawable.ic_live_tv,
                    ...
                    Screen.CardListScreen(
                        ...
                        elements = listOf(
                            Element.Card(
                                ...
                                title = LocalizedString(R.string.drm_general),
                                elements = listOfNotNull(
                                    ...
                                    Element.Item(
                                        identifier = identifier / "algorithms",
                                    ...
                                    runCatching {
                                        ...
                                        Element.Item(
                                            identifier = identifier / "device_unique_id",
                                    ...
                                    *if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                                        listOfNotNull(
                                            runCatching {
                                                ...
                                                Element.Item(
                                                    identifier = identifier / "open_session_count",
                                            ...
                                            runCatching {
                                                ...
                                                Element.Item(
                                                    identifier = identifier / "max_session_count",
                                            ...
                                            runCatching {
                                                ...
                                                Element.Item(
                                                    identifier = identifier / "connected_hdcp_level",
                                            ...
                                            runCatching {
                                                ...
                                                Element.Item(
                                                    identifier = identifier / "max_hdcp_level",
                                    ...
                                    runCatching {
                                        ...
                                        Element.Item(
                                            identifier = identifier / "security_level",
                                    ...
                                    runCatching {
                                        ...
                                        Element.Item(
                                            identifier = identifier / "system_id",
