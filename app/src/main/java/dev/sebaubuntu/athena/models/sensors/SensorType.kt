    ...
    companion object {
        ...
        val all = mutableMapOf(
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                ...
                put(Sensor.TYPE_ACCELEROMETER_LIMITED_AXES_UNCALIBRATED, ACCELEROMETER_LIMITED_AXES_UNCALIBRATED)
                put(Sensor.TYPE_GYROSCOPE_LIMITED_AXES_UNCALIBRATED, GYROSCOPE_LIMITED_AXES_UNCALIBRATED)
