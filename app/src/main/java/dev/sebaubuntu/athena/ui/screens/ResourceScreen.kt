    ...
    FlowResultComposable(
        ...
        PermissionsGatedComposable(
            ...
            FlowResultComposable(
                ...
                when (resource) {
                    is Element -> when (resource) {
                        is Element.Card -> CardElementCard(
                            element = resource,
                            modifier = Modifier
                                .fillMaxWidth()
                        ...
                        is Element.Item -> ItemElementListItem(
                            element = resource,
                            modifier = Modifier
                                .padding(paddingValues)
                                .verticalScroll(rememberScrollState()),
...
private fun ItemElementListItem(
    ...
    ListItem(
        ...
        modifier = modifier.clickable(
            enabled = element.isNavigable,
            role = Role.Button,
            onClick = {
                if (element.isNavigable) {
                    onNavigateTo(element.identifier)
                }
            }
        ),
        overlineContent = {
            Text(
                text = element.identifier.toUri().toString(),
            )
        },
        ...
        trailingContent = when (element.isNavigable) {
            true -> {
                {
                    Icon(
