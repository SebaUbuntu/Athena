                            ...
                            Element.Card(
                                ...
                                elements = listOfNotNull(
                                    ...
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                                        Element.Item(
                                            identifier = identifier / "general" / "canonical_name",
                                    ...
                                    Element.Item(
                                        identifier = identifier / "general" / "is_encoder",
                                        title = LocalizedString(R.string.media_codec_is_encoder),
                                        value = Value(mediaCodecInfo.isEncoder),
                                    ),
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                                        Element.Item(
                                            identifier = identifier / "general" / "is_hardware_accelerated",
                                    ...
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                                        Element.Item(
                                            identifier = identifier / "general" / "is_software_only",
                                    ...
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                                        Element.Item(
                                            identifier = identifier / "general" / "is_vendor",
                                    ...
                                    Element.Item(
                                        identifier = identifier / "general" / "supported_types",
