...
class AudioModule(context: Context) : Module {
                                ...
                                Element.Card(
                                    ...
                                    elements = listOfNotNull(
                                        ...
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                                            Element.Item(
                                                identifier = identifier / "general" / "address",
                                        ...
                                        Element.Item(
                                            identifier = identifier / "general" / "role",
    ...
    companion object {
        private val audioModeToStringResId = mutableMapOf(
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                put(AudioManager.MODE_CALL_SCREENING, R.string.audio_mode_call_screening)
            }

            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                put(AudioManager.MODE_CALL_REDIRECT, R.string.audio_mode_call_redirect)
                put(AudioManager.MODE_COMMUNICATION_REDIRECT, R.string.audio_mode_communication_redirect)
            }
        }.toMap()
        ...
        private val deviceTypeToDrawableRes = mutableMapOf(
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                this[AudioDeviceInfo.TYPE_USB_HEADSET] = dev.sebaubuntu.athena.core.R.drawable.ic_usb
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                this[AudioDeviceInfo.TYPE_HEARING_AID] = dev.sebaubuntu.athena.core.R.drawable.ic_hearing
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                this[AudioDeviceInfo.TYPE_BUILTIN_SPEAKER_SAFE] = dev.sebaubuntu.athena.core.R.drawable.ic_speaker
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                this[AudioDeviceInfo.TYPE_REMOTE_SUBMIX] = dev.sebaubuntu.athena.core.R.drawable.ic_cast
                this[AudioDeviceInfo.TYPE_BLE_HEADSET] = dev.sebaubuntu.athena.core.R.drawable.ic_phone_bluetooth_speaker
                this[AudioDeviceInfo.TYPE_BLE_SPEAKER] = dev.sebaubuntu.athena.core.R.drawable.ic_bluetooth_audio
                this[AudioDeviceInfo.TYPE_HDMI_EARC] = dev.sebaubuntu.athena.core.R.drawable.ic_settings_input_hdmi
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                this[AudioDeviceInfo.TYPE_BLE_BROADCAST] = dev.sebaubuntu.athena.core.R.drawable.ic_bluetooth_audio
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
                this[AudioDeviceInfo.TYPE_DOCK_ANALOG] = dev.sebaubuntu.athena.core.R.drawable.ic_dock
            }
        }.toMap()
