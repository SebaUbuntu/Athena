...
Java_dev_sebaubuntu_athena_modules_gpu_utils_VkUtils_getVkInfo(
    ...
    auto vkPhysicalDevicesClass = JNI_CHECK(env, env->GetObjectClass(vkInfoList));
    auto addDeviceMethodId = JNI_CHECK(env, env->GetMethodID(
    ...
    for (const auto &device: devices) {
        ...
        JNI_CHECK(env, env->CallBooleanMethod(
                ...
                JNI_CHECK(env, env->NewStringUTF(deviceProperties.deviceName))));
    }
