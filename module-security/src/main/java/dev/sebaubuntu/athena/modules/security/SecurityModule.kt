                    ...
                    Element.Card(
                        ...
                        elements = listOfNotNull(
                            runCatching {
                                ...
                                Element.Item(
                                    identifier = identifier / "general" / "is_device_fully_updated",
        ...
        return Element.Card(
            ...
            elements = listOfNotNull(
                deviceSecurityPatchLevel?.let {
                    Element.Item(
                        identifier = identifier / "device_security_patch_level",
                ...
                *if (vulnerabilityReportLoaded) {
                    listOfNotNull(
                        runCatching {
                            ...
                            Element.Item(
                                identifier = identifier / "published_security_patch_level",
                        ...
                        runCatching {
                            ...
                            Element.Item(
                                identifier = identifier / "patched_cves",
